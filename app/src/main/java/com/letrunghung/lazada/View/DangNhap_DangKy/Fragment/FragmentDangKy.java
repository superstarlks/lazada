...
import com.letrunghung.lazada.Presenter.DangKy.PresenterLogicDangKy;
...
public class FragmentDangKy extends Fragment implements ViewDangKy,View.OnClickListener,View.OnFocusChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        presenterLogicDangKy = new PresenterLogicDangKy(this,getActivity());
    ...
    private void btnDangKy(){
        ...
        if(kiemtrathongtin) {
            ...
            nhanVien.setMaLoaiNV(2); //khach hàng
