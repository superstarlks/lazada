...
import com.letrunghung.lazada.Adapter.ExpandAdapter;
...
public class TrangChuActivity extends AppCompatActivity implements ViewXuLyMenu,GoogleApiClient.OnConnectionFailedListener,AppBarLayout.OnOffsetChangedListener {
    public static final String SERVER_NAME = "http://192.168.0.25:8181/weblazada/loaisanpham.php";
    public static final String SERVER= "http://192.168.0.25:8181/weblazada";
    Toolbar toolbar;
    TabLayout tabLayout;
    ViewPager viewPager;
